  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={`${styles.sectionSubText} dark:text-stone-500`}>Mon parcours de développeur</p>
        <h2 className={`${styles.sectionHeadText} dark:text-stone-700`}>Expériences</h2>
      </motion.div>
