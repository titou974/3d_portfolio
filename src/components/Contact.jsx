  ...
  return (
    <div className="overflow-hidden center">
      <motion.div
        ...
        className="bg-black-100 p-8 rounded-2xl anim-disabled md:w-8/12 mx-auto"
      >
        <p className={styles.sectionSubText}>Application, site, ou autre</p>
        ...
        >
          ...
          <div
            ...
            } text-white flex items-center bg-[#38a169] py-3 px-2 rounded-md`}
          >
          ...
          <div
            ...
            } text-white flex items-center bg-[#dd6b20] py-3 px-2 rounded-md`}
          >
