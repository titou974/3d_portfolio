    ...
    <div className='overflow-hidden center'>
      ...
      <div className="main">
        ...
        <div className="down">
          ...
          <a href="https://discordapp.com/users/titou974" rel="noreferrer" target="_blank">
